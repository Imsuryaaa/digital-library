                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                @if ($item->status == 'belum')   
                                    <a href="{{'/indexTransaksiBuku/'.$item->id_peminjaman}}" class="btn btn-secondary btn-xs bg-gray-600 hover:bg-gray-700">Process now!</a>                                 
                                    {{-- <button onclick="myModal{{$item->id_peminjaman}}.showModal()" class="btn btn-secondary btn-xs bg-gray-600 hover:bg-gray-700">Process now!</button> --}}
                                @else
                                    SELESAI
                                @endif
                            </td>
