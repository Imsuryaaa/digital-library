...
<div class="min-h-screen overflow-y-auto">
    <div class="flex items-center justify-center">
        <div class="card w-96 bg-[#B9D7EA] shadow-xl text-black">
            <div class="card-body">
                <p class="text-center text-xl font-bold mb-3">ALL USERS</p>
                <p class="text-center font-bold">{{$userPeminjam}}</p>
            </div>
        </div>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        <a href="/transaksiUserPengembalian/{{$item->id}}" class="btn btn-secondary btn-xs bg-gray-600 hover:bg-gray-700">Go</a>
                    </th>
                </tr>
                @endforeach
                @endif
