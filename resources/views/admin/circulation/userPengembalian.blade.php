@extends('layout/app')
@section('konten')
<h1 class="text-4xl mb-3">Return Page</h1>
<hr class="mb-2">
<div class="min-h-screen overflow-y-auto">
    ...
    <div class="overflow-x-auto mt-6">
        ...
        <div class="flex justify-end mb-4 mr-4">
            ...
            <form action="{{ url('/pilihUserPeengembalian') }}" method="GET">
            ...
            @else
            <form action="{{ url('/officer/pilihUserPeengembalian') }}" method="GET">
                <input type="text" id="bookId" placeholder="Search..." name="search" class="px-2 py-1 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 ml-2 rounded">Search</button>
            </form>
            @endif
        ...
        <table class="table">
            ...
            <tbody class="divide-y divide-[#D6E6F2]">
                ...
                <tr>
                    ...
                    <th>
                        @if (Auth::user()->level == 'admin')
                        <a href="/transaksiUserPengembalian/{{$item->id}}" class="btn btn-xs bg-[#427909] hover:bg-[#174E71] text-white">Go</a>
                        @else            
                        <a href="/officer/transaksiUserPengembalian/{{$item->id}}" class="btn btn-xs bg-[#427909] hover:bg-[#174E71] text-white">Go</a>
                        @endif
                    </th>
                </tr>
                @endforeach
